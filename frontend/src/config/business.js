export const BUSINESS = {
  ...
  dealsIn: [
    'All kinds of Aromatics Chemicals',
    'Pan Masala & Zafrani Jarda compounds',
    'Attars / perfume oils and fragrance solutions for personal and trade needs',
  ],
  offices: {
    kannauj: {
    ...
    mumbai: {
      label: 'Mumbai Office',
      address:
        'Office No. 6, 1st Floor, Ashmul Ko House, 395/397 NarshiNatha Street, Masjid Bandar, Mumbai - 400009.',
    },
  },
}
